...
const routes: RouteConfig[] = [
  {
    ...
    children: [
      ...
      { path: '/groups/add', component: () => import('pages/groups/GroupAdd.vue'), name: 'groupAdd', meta: { auth: true, noFooter: true } },
      { path: '/groups/:groupId/edit', component: () => import('pages/groups/GroupEdit.vue'), name: 'groupEdit', meta: { auth: true, noFooter: true } },
